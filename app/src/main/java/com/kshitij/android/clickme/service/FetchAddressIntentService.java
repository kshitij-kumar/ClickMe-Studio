package com.kshitij.android.clickme.service;
...
/**
 * A background service which retrieves location address from supplied Location
 * 
 */

public class FetchAddressIntentService extends IntentService {
	private static final String TAG = FetchAddressIntentService.class
			.getSimpleName();
